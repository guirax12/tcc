            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <ol class="breadcrumb primary">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-tasks"></i>Operacional</a>
                        </li>
                        <li class="active">
                            <strong><i class="fa fa-user"></i>Negativação por Dívida</strong>
                        </li>
                    </ol>
            ...
            <div class="col-lg-12">
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">Negativação por Dívida</h2>
...
<script src="../../js/operacional/divida.js" type="text/javascript"></script>